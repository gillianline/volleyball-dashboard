...
st.markdown("""
    ...
    /* PDF Print Logic - Only affects printing */
    @media print {
        .no-print, [data-testid="stSidebar"], .stTabs [role="tablist"] { display: none !important; }
...
try:
    ...
    with tabs[4]:
        ...
        if selected_matches:
                        ...
                        with card_cols[j]:
                            ...
                            <div class="gallery-card">
                                <div style="display:flex; align-items:center; gap:15px; padding:15px; background:#f8f9fa; border-bottom:2px solid #FF8200;">
                                    <img src="{ath_data_t['PhotoURL'].iloc[0]}" class="gallery-photo" style="width:80px; height:80px;">
                                    <div>
            ...
            st.markdown('<div class="section-header">Team Match Averages (Same Day Distinguished)</div>', unsafe_allow_html=True)
