...
def load_all_data():
    ...
    df['Sheet_Order'] = range(len(df)) # Track Excel order for same-day matches
...
try:
    ...
    with tabs[4]:
        ...
        st.markdown('<style>@media print { .print-hide { display: none !important; } }</style>', unsafe_allow_html=True)
