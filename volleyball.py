...
try:
    ...
    with tabs[2]:
        ...
        if not w_data.empty and not g_data_l.empty:
            ...
            w_avg = w_data[low_m + ([dist_m] if dist_m else [])].mean(); g_d = g_data_l.iloc[0]; cg1, cg2 = st.columns([1, 2])
            with cg1:
                    ...
                    if i + j < len(ath_t):
                        ...
                        with card_cols[j]:
                            ...
                            for _, r in ad.iterrows():
                                # Swapped: Efforts before Distance
