    ...
    try:
        ...
        with tabs[0]: # Individual Profile
            ...
            if not day_df.empty:
                ...
                # Apply position filter for the dropdown list
                ...
                # GET DATA: Calculate lb from FULL df to ensure Max is accurate
                ...
                # ... (Readiness and Phase logic follows here)
