    ...
    try:
        ...
        if selected_season == "Testing":
            ...
            if selected_testing_tab == "CMJ Dashboard":
                ...
                if sel_cmj_mode == "Individual Athlete":
                    ...
                    if ath_cmj_all.empty:
                        ...
                        with chart_col:
                            ...
                            # Shortened Speed box to not include Jump Height (covers indices 1 and 2: Jump Momentum & Peak Velocity)
                            category_boxes = [
                ...
                # --- SUB-TAB 2: TEAM CMJ SUMMARY TABLE (RESTORED CLEAN SCOUT TABLE) ---
