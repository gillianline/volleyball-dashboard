...
st.markdown("""
    ...
    @media print {
        .stTabs [role="tablist"], .no-print, [data-testid="stSidebar"] { display: none !important; }
                    ...
                    if i + j < len(gal_df):
                        ...
                        for k in all_metrics:
                            if k in pd_row:
                                ...
                                r_html += f"<tr><td>{k}</td><td>{v}</td><td>{g}</td></tr>"
                        ...
                        with card_cols[j]:
                            ...
                            <div class="gallery-card">
                                <div style="display:flex; align-items:center; gap:15px; padding:15px; background:#f8f9fa; border-bottom:2px solid #FF8200;">
                                    <img src="{ath_data_t['PhotoURL'].iloc[0]}" style="width:70px; border-radius:50%;">
                                    <div>
