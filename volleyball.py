    ...
    with tabs[0]:
        ...
        if not day_df.empty:
            ...
            if not p_ph.empty:
                ...
                if 'Estimated Distance (y)' in p_ph.columns:
                    fig_ph.add_trace(go.Scatter(x=p_ph['Phase'], y=p_ph['Estimated Distance (y)'], name="Distance (y)", line=dict(color='#515154', width=2, dash='dash')), secondary_y=True)
