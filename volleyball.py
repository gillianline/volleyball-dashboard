...
if check_password():
    # --- CSS: SURGICAL PRINT FIX & FORMATTING ---
    st.markdown("""
        <style>
        ...
        .player-row-container { break-inside: avoid !important; page-break-inside: avoid !important; display: block; margin-bottom: 30px; }
        ...
        @media print {
            ...
            #print-hide-header, .print-hide { display: none !important; height: 0 !important; margin: 0 !important; padding: 0 !important; }
    ...
    try:
        ...
        # --- TAB 2: GAME V PRACTICE (RESTORED) ---
        with tabs[2]:
        ...
        # --- TAB 3: POSITION ANALYSIS (RESTORED) ---
        with tabs[3]:
        ...
        # --- TAB 4: MATCH SUMMARY (PRINT FIXES ONLY) ---
        with tabs[4]:
