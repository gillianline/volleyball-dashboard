...
if check_password():
    ...
    st.markdown("""
        ...
        @media print {
            ...
            .stTabs [role="tablist"], [data-testid="stSidebar"], header, footer, [data-testid="stHeader"], .print-hide,
            button, #print-selector-block { 
    ...
    try:
        ...
        with tabs[4]:
            ...
            st.markdown('<div id="print-selector-block"><div class="section-header">Match Comparison Selection</div>', unsafe_allow_html=True)
