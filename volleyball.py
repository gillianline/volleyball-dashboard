...
if check_password():
    ...
    st.markdown("""
        ...
        .player-divider { border: 0; height: 1px; background: #E5E5E7; margin: 20px 0; }
        ...
        @media print {
            ...
            header, footer, [data-testid="stHeader"], .print-hide, button { display: none !important; }
            [data-testid="stMultiSelect"] span, .stMultiSelect [role="button"] { background-color: transparent !important; border: none !important; color: #000 !important; }
