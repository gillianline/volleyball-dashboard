...
if check_password():
    ...
    def load_all_data():
        ...
        # Process ASH Shoulder Test Sheet
        try:
        ...
        # Process Range of Motion (ER) Sheet
        try:
    ...
    try:
        ...
        # Master broad names index array across performance records to prevent lookup lockups
        master_athlete_list = sorted(list(set(df['Name'].unique()) | set(cmj_df['Athlete'].unique()) | set(ash_df['Name'].unique()) | set(er_df['Name'].unique())))
        ...
        with tabs[0]: # Tab 0: Individual Profile
            ...
            # --- FALLBACK PROCESSING OBJECT FOR EXCLUSIVE TESTING JUMP FIELDS ---
            if p_row.empty:
            ...
            if not p_row.empty:
                ...
                with jc2:
                    if not p_cmj_hist.empty:
                        ...
                        fig.add_trace(go.Scatter(x=p_cmj_hist['Test Date'], y=p_cmj_hist['RSI-modified [m/s]'], name="RSI Modified", mode='lines+markers', line=dict(color='#4895DB', dash='dot')), secondary_y=True)
